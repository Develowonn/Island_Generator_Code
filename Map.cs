...
public class Map
{
    ...
    public void InitializeSpawnPosition()
    {
        Vector3 spawnPosition = new Vector3(
                ChunkConfig.ChunkWidthValue * mapSettingManager.MapSizeInChunks * 0.5f,
                ChunkConfig.ChunkHeightValue,
                ChunkConfig.ChunkLengthValue * mapSettingManager.MapSizeInChunks * 0.5f
        );
    ...
    private void UpdateChunkInViewRange()
    {
        ...
        {
            Vector2Int coord = chunk.chunkData.coord;
    ...
    public bool IsVoxelInMap(Vector3 pos)
    {
        ...
        if (x < 0 || x >= (mapSettingManager.MapSizeInChunks * ChunkConfig.ChunkWidthValue) ||
            z < 0 || z >= (mapSettingManager.MapSizeInChunks * ChunkConfig.ChunkLengthValue) ||
